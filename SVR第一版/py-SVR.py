...
data2 = data.to_numpy()
data_train = data2[0:3287,0:4]
data_test = data2[3288:3653,0:4]
y_train = data2[0:3287,4]
y_test = data2[3288:3653,4]
...
sigmoid_pred_true.to_excel(r'D:\肖牧瑶\SJTU\大一\Projet Scientifique\天气预测\MyProjects\SVR第一版\预测值与真实值-rbf.xlsx',index = False)
