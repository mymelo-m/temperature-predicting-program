...
data = pd.read_excel('SH10yTemp-4.xlsx')
data2 = data.to_numpy()
...
sigmoid_pred_true.to_excel(r'D:\肖牧瑶\SJTU\大一\Projet Scientifique\天气预测\MyProjects\SVR第四版\预测值与真实值.xlsx',index = False)
