...
data = pd.read_excel('SH10yTemp-2.xlsx')
data2 = data.to_numpy()
data_train = data2[0:3287,0:6]
data_test = data2[3288:3653,0:6]
y_train = data2[0:3287,6]
y_test = data2[3288:3653,6]
...
sigmoid_pred_true.to_excel(r'D:\肖牧瑶\SJTU\大一\Projet Scientifique\天气预测\MyProjects\SVR第二版\预测值与真实值.xlsx',index = False)
